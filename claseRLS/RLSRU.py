...
# Cargamos el archivo 
carpeta = '~/Clase 16/'
data_train = pd.read_csv("datos_roundup.txt", sep=" ", encoding='utf-8')
...
carpeta = '~/Downloads/'
data_a_predecir = pd.read_csv("datos_a_predecir.txt", sep=" ", encoding='utf-8')
...
data_libreta = pd.read_csv("datos_libreta_90622.txt", sep=" ", encoding='utf-8')
...
datos = pd.read_csv(".txt", sep=" ", encoding='utf-8')
